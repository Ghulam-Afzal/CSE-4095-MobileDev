...
class MainActivity : AppCompatActivity() {
    ...
    val urlJSON = "http://10.0.0.193:8080/questions";
    val urlIMAGE = "http://10.0.0.193:8080/static/stamford_harbor.jpg";
...
// Instantiate the RequestQueue.
            ...
            val jsonArrayRequest = JsonArrayRequest(Request.Method.GET,
                ...
                { response ->
                    ...
                    extractQuestionsfromJson(response)
                },
    ...
    private fun extractQuestionsfromJson(response: JSONArray) {
        for (i in 0 until response.length()) {
            val questionObject = response.getJSONObject(i)
            Log.i("questionable", "q $i $questionObject.toString()")
        }
    }

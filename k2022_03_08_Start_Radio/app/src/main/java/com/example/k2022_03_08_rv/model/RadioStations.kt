...
class RadioStations() {
    ...
    init {
        ...
        stations.add(RadioStation("The Krush Wine Countr Netherlands",
            "https://19213.live.streamtheworld.com/KRSHFM.mp3"))
        stations.add(RadioStation("Haarlem 105 Germany",
            "http://stream.haarlem105.nl:8000/haarlem105low.mp3\n"))
        ...
        stations.add(RadioStation("WNYC",
            "http://sgrewind.streamguys1.com/wnycfm/wnycfm.aac/playlist.m3u8"))
